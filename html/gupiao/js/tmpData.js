...
$(function(){
	...
	$.ajax({
		type:"post",
		url:"http://www.10xunc.com/WSHD/jiekou/globalindex?id=0&page=0&num=240",
		dataType:"JSON",
		data:{},
		success:function(res){
			// console.log(res.data);
			var mdata={"data":res.data,"yestclose":res.prevclose};
			// console.log(mdata)
			var mChart = echarts.init(document.getElementById('m-line'));
			mChart.setOption(initMOption(mdata,'hs'));
			console.log(132)
...
//  },100000)
	...
	// setInterval(function(){
		$.ajax({
			type:"post",
			url:"http://www.10xunc.com/WSHD/jiekou/globalindex?id=1&page=1&num=240",
			dataType:"JSON",
			data:{},
			success:function(res){
				// console.log(res.data);
				var mdata={"data":res.data,"yestclose":res.prevclose};
				// console.log(mdata)
				var mChart = echarts.init(document.getElementById('m-lineo'));
				mChart.setOption(initMOption(mdata,'hs'));
	...
	//创业板
		$.ajax({
			type:"post",
			url:"http://www.10xunc.com/WSHD/jiekou/globalindex?id=2&page=1&num=240",
			dataType:"JSON",
			data:{},
			success:function(res){
				// console.log(res.data);
				var mdata={"data":res.data,"yestclose":res.prevclose};
				// console.log(mdata)
				var mChart = echarts.init(document.getElementById('m-linet'));
       			mChart.setOption(initMOption(mdata,'hs'));
			}
		});
	...
	$.ajax({
		type:"post",
		url:"http://www.10xunc.com/WSHD/jiekou/globalindex?id=3&page=1&num=240",
		dataType:"JSON",
		data:{},
		success:function(res){
			// console.log(res.data);
			var mdata={"data":res.data,"yestclose":res.prevclose};
			// console.log(mdata)
			var mChart = echarts.init(document.getElementById('m-lineth'));
        	mChart.setOption(initMOption(mdata,'hs'));
		}
	});
	//日经指数
	$.ajax({
		type:"post",
		url:"http://www.10xunc.com/WSHD/jiekou/globalindex?id=4&page=1&num=240",
		dataType:"JSON",
		data:{},
		success:function(res){
			// console.log(res.data);
			var mdata={"data":res.data,"yestclose":res.prevclose};
			// console.log(mdata)
			var mChart = echarts.init(document.getElementById('m-linef'));
        	mChart.setOption(initMOption(mdata,'hs'));
		}
	});
	//澳大利亚
	$.ajax({
		type:"post",
		url:"http://www.10xunc.com/WSHD/jiekou/globalindex?id=5&page=1&num=240",
		dataType:"JSON",
		data:{},
		success:function(res){
			// console.log(res.data);
			var mdata={"data":res.data,"yestclose":res.prevclose};
			// console.log(mdata)
			var mChart = echarts.init(document.getElementById('m-linev'));
        	mChart.setOption(initMOption(mdata,'hs'));
		}
	});
	//韩国综合
	$.ajax({
		type:"post",
		url:"http://www.10xunc.com/WSHD/jiekou/globalindex?id=6&page=1&num=240",
		dataType:"JSON",
		data:{},
		success:function(res){
			// console.log(res.data);
			var mdata={"data":res.data,"yestclose":res.prevclose};
			// console.log(mdata)
			var mChart = echarts.init(document.getElementById('m-lines'));
        	mChart.setOption(initMOption(mdata,'hs'));
		}
	});
...
// var mdata = { 
// 	"data": [//时间   当前价  均价   交易量
// 		[1329,2933.54,2952.34],[1330,2933.54,2952.34],[1331,2933.9,2952.34],[1332,2933.72,2952.34],[1333,2935.46,2952.34],[1338,2935.37,2952.34],[1339,2935.6,2952.34],[1340,2935.6,2952.34],[1341,2935.74,2952.34],[1342,2936.23,2952.34],[1343,2936.51,2952.34],[1344,2936.51,2952.34],[1345,2936.08,2952.34],[1346,2936.31,2952.34],[1347,2935.9,2952.34],[1348,2936.27,2952.34],[1349,2937.65,2952.34],[1350,2937.65,2952.34],[1351,2939.19,2952.34],[1352,2940.27,2952.34],[1353,2939.88,2952.34],[1354,2939.92,2952.34],[1355,2939.86,2952.34],[1356,2938.14,2952.34],[1357,2938.14,2952.34],[1358,2937.85,2952.34],[1359,2938.07,2952.34],[1400,2937.63,2952.34],[1401,2938.94,2952.34],[1402,2939.14,2952.34],[1403,2938.69,2952.34],[1404,2939.69,2952.34],[1405,2939.51,2952.34],[1406,2939.51,2952.34],[1407,2939.59,2952.34],[1408,2939.31,2952.34],[1409,2938.67,2952.34],[1410,2938.45,2952.34],[1411,2938.2,2952.34],[1412,2938.2,2952.34],[1413,2937.69,2952.34],[1414,2937.76,2952.34],[1415,2936.82,2952.34],[1416,2936.5,2952.34],[1417,2936.16,2952.34],[1418,2935.83,2952.34],[1419,2935.94,2952.34],[1420,2935.94,2952.34],[1421,2935.73,2952.34],[1422,2935.6,2952.34],[1423,2936.51,2952.34],[1424,2936.26,2952.34],[1425,2936.43,2952.34],[1426,2935.94,2952.34],[1427,2935.45,2952.34],[1428,2935.53,2952.34],[1429,2935.53,2952.34],[1430,2935.47,2952.34],[1431,2934.74,2952.34],[1432,2934.71,2952.34]
// 	],
// 	"yestclose": 2941.01
// };

// console.log(mdata.yestclose)
// var mdatao = { 
// 	"data": [//时间   当前价  均价   交易量
// 		["0930", 33.02, 33.02, 8200,10000],
